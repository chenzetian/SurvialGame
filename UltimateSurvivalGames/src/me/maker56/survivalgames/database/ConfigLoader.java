...
public class ConfigLoader {
	...
	public static void reloadConfig() {
		...
		c.addDefault("Job-Item-S", Material.APPLE + " name:&eS lore:&7Rightclick_to_choose_S");
		c.addDefault("Job-Item-She", Material.BOW + " name:&eShe lore:&7Rightclick_to_choose_she" );
		c.addDefault("Job-Item-Th", Material.BOW + " name:&eTh lore:&7Rightclick_to_choose_Th" );
		c.addDefault("Jobs", "302,303,304,305");
